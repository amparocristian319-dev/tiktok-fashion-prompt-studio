...
- prompt_templates/scene_planner.md
- prompt_templates/asset_card_builder.md

Important:
- auto_recommend.md must keep {clothing_profile}
- video_prompt_generator.md must keep {clothing_profile}, {user_settings}, and {scene_plan}
- scene_planner.md must keep {clothing_profile} and {user_settings}
"""
...
SCENE_PLANNER_PROMPT = _read_prompt("scene_planner.md")
ASSET_CARD_BUILDER_PROMPT = _read_prompt("asset_card_builder.md")
...
def build_scene_plan_prompt(clothing_profile: str, user_settings: str) -> str:
    return SCENE_PLANNER_PROMPT.format(
        clothing_profile=clothing_profile,
        user_settings=user_settings,
    )


def build_video_prompt(clothing_profile: str, user_settings: str, scene_plan: str = "") -> str:
...
def build_asset_card_prompt(vision_brief: str) -> str:
    return ASSET_CARD_BUILDER_PROMPT.format(vision_brief=vision_brief)
