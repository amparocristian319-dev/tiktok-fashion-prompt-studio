        ...
        st.markdown(
            ...
            <div class="api-shell">
              ...
              <div>
                ...
                <div class="api-main-sub">支持火山方舟 OpenAI 兼容接口。可临时在页面测试，也可复制配置到 Streamlit Secrets 长期使用。</div>
              </div>
            </div>
            """,
            unsafe_allow_html=True,
        ...
        if mode == "临时页面配置（适合测试）":
            ...
            with col2:
                ...
                seed_model = st.text_input(
                    ...
                    value=current.get("DOUBAO_SEED21_PRO_MODEL_ID", ""),
                    placeholder="例如 ep-xxxxxxxx 或控制台显示的模型/endpoint id",
                )
